      ...
      players: [
        {
          ...
          clergy: ['LB1R', 'LB2R'],
          landscape: [
            [[], [], ['P', 'LMO'], ['P', 'LFO'], ['P', 'LFO'], ['P', 'G06', 'PRIR'], ['H', 'LR1'], [], []],
...

        {
          ...
          landscape: [
            ...
            [[], [], ['P', 'LMO'], ['P', 'LFO'], ['P', 'LR2'], ['P', 'G01', 'PRIG'], ['P', 'LR3', 'LB1G'], [], []],
          ] as Tile[][],
          landscapeOffset: 1,
        },

        {
          ...
          clergy: ['LB2B'],
          landscape: [
            [[], [], ['P', 'LMO'], ['P', 'LFO'], ['P', 'LFO'], ['P'], ['H', 'LR1', 'LB1B'], [], []],
            [[], [], ['P', 'LMO'], ['P', 'LFO'], ['P', 'LR2'], ['P', 'G13', 'PRIB'], ['P', 'LR3'], [], []],
          ] as Tile[][],
          landscapeOffset: 0,
        },
      ],
