...
describe('game 29767', () => {
  it('runs through moves', () => {
    ...
    const s2 = reducer(s1, ['START', '42', 'R'])! as GameState
    ...
    const s3 = reducer(s2, ['CUT_PEAT', '0', '0'])! as GameState
    ...
    const s13 = reducer(s12, ['BUILD', 'G07', '3', '0'])! as GameState
    ...
    const s14 = reducer(s13, ['USE', 'G07', 'PtPtPtPt'])! as GameState
    ...
    const s15 = reducer(s14, ['COMMIT'])! as GameState
    ...
    const s16 = reducer(s15, ['CONVERT', 'Gn'])! as GameState
    expect(s16.players![0]).toMatchObject({
      grain: 1,
      straw: 1,
    })

    const s17 = reducer(s16, ['BUILD', 'G06', '0', '0'])! as GameState
