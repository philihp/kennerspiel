...
describe('game 29767', () => {
  it('runs through moves', () => {
    ...
    const s13 = reducer(s12, ['BUILD', 'G07', '3', '0'])!
    ...
    const s14 = reducer(s13, ['USE', 'G07', 'PtPtPtPt'])!
    ...
    const s16 = reducer(s15, ['CONVERT', 'Gn'])!
    expect(s16.players![0]).toMatchObject({
      grain: 1,
      straw: 1,
    })

    const s17 = reducer(s16, ['BUILD', 'G06', '0', '0'])!
