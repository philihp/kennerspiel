...
const RondelSettlementsFourLong = () => (
  <>
    ...
    <g id="settlement-b" transform={`rotate(${rot.J})`}>
      <path d={housePath} style={{ fill: 'url(#housefill)', fillOpacity: 1, stroke: '#202020', strokeWidth: 1 }} />
      <text x="0" y={houseTextY} style={{ fontSize: '9px', fontWeight: 100, textAnchor: 'middle', fill: '#fff' }}>
        B
      </text>
    ...
    <g id="settlement-d" transform={`rotate(${rot.F})`}>
      <path d={housePath} style={{ fill: 'url(#housefill)', fillOpacity: 1, stroke: '#202020', strokeWidth: 1 }} />
      <text x="0" y={houseTextY} style={{ fontSize: '9px', fontWeight: 100, textAnchor: 'middle', fill: '#fff' }}>
        D
      </text>
    </g>
    <g id="settlement-e" transform={`rotate(${rot.L})`}>
      <path d={housePath} style={{ fill: 'url(#housefill)', fillOpacity: 1, stroke: '#202020', strokeWidth: 1 }} />
      <text x="0" y={houseTextY} style={{ fontSize: '9px', fontWeight: 100, textAnchor: 'middle', fill: '#fff' }}>
        E
      </text>
...
const RondelSettlementsThreeLong = () => (
  <>
    <g id="settlement-a" transform={`rotate(${rot.F})`}>
      <path d={housePath} style={{ fill: 'url(#housefill)', fillOpacity: 1, stroke: '#202020', strokeWidth: 1 }} />
      <text x="0" y={houseTextY} style={{ fontSize: '9px', fontWeight: 100, textAnchor: 'middle', fill: '#fff' }}>
        A
      </text>
    ...
    <g id="settlement-c" transform={`rotate(${rot.B})`}>
      <path d={housePath} style={{ fill: 'url(#housefill)', fillOpacity: 1, stroke: '#202020', strokeWidth: 1 }} />
      <text x="0" y={houseTextY} style={{ fontSize: '9px', fontWeight: 100, textAnchor: 'middle', fill: '#fff' }}>
        C
      </text>
...
const RondelSettlementsThreeFourShort = () => (
  <>
    <g id="income-a" transform={`rotate(${rot.A})`}>
...
const RondelSettlementsSolitare = () => (
  <>
    <g id="settlement-a" transform={`rotate(${rot.L})`}>
      <path d={`${housePath}`} style={{ fill: 'url(#housefill)', fillOpacity: 1, stroke: '#202020', strokeWidth: 1 }} />
      <text x="0" y={houseTextY} style={{ fontSize: '9px', fontWeight: 100, textAnchor: 'middle', fill: '#fff' }}>
        A
      </text>
    </g>
    <g id="settlement-b" transform={`rotate(${rot.C})`}>
      <path d={`${housePath}`} style={{ fill: 'url(#housefill)', fillOpacity: 1, stroke: '#202020', strokeWidth: 1 }} />
      <text x="0" y={houseTextY} style={{ fontSize: '9px', fontWeight: 100, textAnchor: 'middle', fill: '#fff' }}>
        B
      </text>
    ...
    <g id="settlement-d" transform={`rotate(${rot.M})`}>
      <path d={`${housePath}`} style={{ fill: 'url(#housefill)', fillOpacity: 1, stroke: '#202020', strokeWidth: 1 }} />
      <text x="0" y={houseTextY} style={{ fontSize: '9px', fontWeight: 100, textAnchor: 'middle', fill: '#fff' }}>
        D
      </text>
    </g>
    <g id="settlement-e" transform={`rotate(${rot.F})`}>
      <path d={`${housePath}`} style={{ fill: 'url(#housefill)', fillOpacity: 1, stroke: '#202020', strokeWidth: 1 }} />
      <text x="0" y={houseTextY} style={{ fontSize: '9px', fontWeight: 100, textAnchor: 'middle', fill: '#fff' }}>
        E
      </text>
...
const RondelSettlementsDuel = () => (
  <>
    ...
    <g id="settlement-b" transform={`rotate(${rot.A})`}>
      <path d={`${housePath}`} style={{ fill: 'url(#housefill)', fillOpacity: 1, stroke: '#202020', strokeWidth: 1 }} />
      <text x="0" y={`${houseTextY}`} style={{ fontSize: '9px', fontWeight: 100, textAnchor: 'middle', fill: '#fff' }}>
        B
      </text>
