...
export const Rondel = () => {
  ...
  return (
    <svg style={{ float: 'left', width: '450px', height: '450px' }} viewBox="-210.5 -210.5 420 420">
      ...
      <g id="wheel">
        <polyline fill="#ffffff" stroke="#e5e7eb" strokeWidth="1" points={wedge.A} />
        <polyline fill="#ffffff" stroke="#e5e7eb" strokeWidth="1" points={wedge.B} />
        <polyline fill="#ffffff" stroke="#e5e7eb" strokeWidth="1" points={wedge.C} />
        <polyline fill="#ffffff" stroke="#e5e7eb" strokeWidth="1" points={wedge.D} />
        <polyline fill="#ffffff" stroke="#e5e7eb" strokeWidth="1" points={wedge.E} />
        <polyline fill="#ffffff" stroke="#e5e7eb" strokeWidth="1" points={wedge.F} />
        <polyline fill="#ffffff" stroke="#e5e7eb" strokeWidth="1" points={wedge.G} />
        <polyline fill="#ffffff" stroke="#e5e7eb" strokeWidth="1" points={wedge.H} />
        <polyline fill="#ffffff" stroke="#e5e7eb" strokeWidth="1" points={wedge.I} />
        <polyline fill="#ffffff" stroke="#e5e7eb" strokeWidth="1" points={wedge.J} />
        <polyline fill="#ffffff" stroke="#e5e7eb" strokeWidth="1" points={wedge.K} />
        <polyline fill="#ffffff" stroke="#e5e7eb" strokeWidth="1" points={wedge.L} />
        <polyline fill="#ffffff" stroke="#e5e7eb" strokeWidth="1" points={wedge.M} />
      </g>
