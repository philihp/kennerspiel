    ...
    <svg style={{ float: 'left', width: '450px', height: '450px' }} viewBox="-210.5 -210.5 420 420">
      <defs>
        <linearGradient id="housefill" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" style={{ stopColor: '#4f378b', stopOpacity: 1 }} />
          <stop offset="100%" style={{ stopColor: '#6750a4', stopOpacity: 1 }} />
        </linearGradient>
        <filter id="shadow">
      ...
      <g id="wheel">
        <polyline fill="#f3edf7" stroke="#cac4d0" strokeWidth="1" points={wedge.A} />
