...
import { concat, equals, filter, includes, join, map, none, reduce, reject, splitEvery } from 'ramda'

const id = BuildingEnum.ChamberOfWonders
...
export const ChamberOfWonders = () => {
  ...
  return (
    <Modal title="Chamber of Wonders" openModal={open} closeModal={handleClose}>
      ...
      <br />
      <>
        Selected {usedResources.length / 2} of 13 different goods to create a wonder
        <br />
        <ItemList
